...
public class BigDecimalStream {
  ...
  /**
   * Returns a sequential ordered {@code Stream<BigDecimal>} from {@code startInclusive} (inclusive)
   ...
   */
  public static Stream<BigDecimal> range(
    ...
    return StreamSupport.stream(
        new BigDecimalSpliterator(startInclusive, endExclusive, false, step, mathContext), false);
  }
   ...
   * to {@code endExclusive} (exclusive) by an incremental {@code step}.
   *
   * <p>The {@code long} arguments are converted using {@link BigDecimal#valueOf(long)}.
   *
   * @param startInclusive the (inclusive) initial value
   * @param endExclusive the exclusive upper bound
   * @param step the step between elements
   ...
   */
  public static Stream<BigDecimal> range(
      long startInclusive, long endExclusive, long step, MathContext mathContext) {
    return range(
        BigDecimal.valueOf(startInclusive),
        BigDecimal.valueOf(endExclusive),
   ...
   * to {@code endExclusive} (exclusive) by an incremental {@code step}.
   *
   * <p>The {@code double} arguments are converted using {@link BigDecimal#valueOf(double)}.
   *
   * @param startInclusive the (inclusive) initial value
   * @param endExclusive the exclusive upper bound
   * @param step the step between elements
   ...
   */
  public static Stream<BigDecimal> range(
      double startInclusive, double endExclusive, double step, MathContext mathContext) {
    return range(
        BigDecimal.valueOf(startInclusive),
        BigDecimal.valueOf(endExclusive),
        BigDecimal.valueOf(step),
   ...
   * @see #range(BigDecimal, BigDecimal, BigDecimal, MathContext)
   */
  public static Stream<BigDecimal> rangeClosed(
      BigDecimal startInclusive,
   ...
   */
  public static Stream<BigDecimal> rangeClosed(
      long startInclusive, long endInclusive, long step, MathContext mathContext) {
    return rangeClosed(
        BigDecimal.valueOf(startInclusive),
        BigDecimal.valueOf(endInclusive),
        BigDecimal.valueOf(step),
        mathContext);
  }
   ...
   */
  public static Stream<BigDecimal> rangeClosed(
      double startInclusive, double endInclusive, double step, MathContext mathContext) {
    return rangeClosed(
        BigDecimal.valueOf(startInclusive),
        BigDecimal.valueOf(endInclusive),
        BigDecimal.valueOf(step),
  ...
  private static class BigDecimalSpliterator extends AbstractSpliterator<BigDecimal> {
    ...
    public BigDecimalSpliterator(
      ...
      this(
          startInclusive,
          step,
          estimatedCount(startInclusive, end, inclusive, step, mathContext),
          mathContext);
    }
    ...
    public Spliterator<BigDecimal> trySplit() {
      ...
      BigDecimal startSecondHalf =
          value.add(step.multiply(new BigDecimal(firstHalfCount), mathContext), mathContext);
