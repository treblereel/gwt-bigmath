...
public class BigFloatStream {
  ...
  /**
   * Returns a sequential ordered {@code Stream<BigFloat>} from {@code startInclusive} (inclusive)
   * to {@code endExclusive} (exclusive) by an incremental {@code step}.
   *
   ...
   */
  public static Stream<BigFloat> range(
      BigFloat startInclusive, BigFloat endExclusive, BigFloat step) {
    if (step.isZero()) {
    ...
    return StreamSupport.stream(
        new BigFloatSpliterator(startInclusive, endExclusive, false, step), false);
  }
   ...
   * to {@code endExclusive} (exclusive) by an incremental {@code step}.
   *
   * <p>{@link Context#valueOf(long)} is used to convert the {@code long} values.
   *
   * @param startInclusive the (inclusive) initial value
   * @param endExclusive the exclusive upper bound
   * @param step the step between elements
   ...
   */
  public static Stream<BigFloat> range(
      long startInclusive, long endExclusive, long step, Context context) {
    return range(
        context.valueOf(startInclusive), context.valueOf(endExclusive), context.valueOf(step));
  }
   ...
   * to {@code endExclusive} (exclusive) by an incremental {@code step}.
   *
   * <p>{@link Context#valueOf(double)} is used to convert the {@code double} values.
   *
   * @param startInclusive the (inclusive) initial value
   * @param endExclusive the exclusive upper bound
   * @param step the step between elements
   ...
   */
  public static Stream<BigFloat> range(
      double startInclusive, double endExclusive, double step, Context context) {
    return range(
        context.valueOf(startInclusive), context.valueOf(endExclusive), context.valueOf(step));
  }
  ...
  /**
   * Returns a sequential ordered {@code Stream<BigFloat>} from {@code startInclusive} (inclusive)
   * to {@code endInclusive} (inclusive) by an incremental {@code step}.
   *
   * <p>An equivalent sequence of increasing values can be produced sequentially using a {@code for}
   * loop as follows:
   *
   ...
   * @return a sequential {@code Stream<BigFloat>}
   */
  public static Stream<BigFloat> rangeClosed(
      BigFloat startInclusive, BigFloat endInclusive, BigFloat step) {
    if (step.isZero()) {
      throw new IllegalArgumentException("invalid step: 0");
    }
    ...
    return StreamSupport.stream(
        new BigFloatSpliterator(startInclusive, endInclusive, true, step), false);
  }
   ...
   */
  public static Stream<BigFloat> rangeClosed(
      long startInclusive, long endInclusive, long step, Context context) {
    return rangeClosed(
        context.valueOf(startInclusive), context.valueOf(endInclusive), context.valueOf(step));
  }
   ...
   */
  public static Stream<BigFloat> rangeClosed(
      double startInclusive, double endInclusive, double step, Context context) {
    return rangeClosed(
        context.valueOf(startInclusive), context.valueOf(endInclusive), context.valueOf(step));
  }
  ...
  private static class BigFloatSpliterator extends AbstractSpliterator<BigFloat> {
    ...
    public BigFloatSpliterator(
        BigFloat startInclusive, BigFloat end, boolean inclusive, BigFloat step) {
      this(startInclusive, step, estimatedCount(startInclusive, end, inclusive, step));
    }

    private static long estimatedCount(
        BigFloat startInclusive, BigFloat end, boolean inclusive, BigFloat step) {
