 ...
 *
 * <p>See <a href="https://de.wikipedia.org/wiki/Taylorreihe">Wikipedia: Taylorreihe</a>
 *
 * <p>No argument checking or optimizations are done. This implementation is <strong>not</strong>
...
public class AsinCalculator extends SeriesCalculator {
  ...
  protected BigRational getCurrentFactor() {
    BigRational factor =
        factorial2n.divide(
            fourPowerN.multiply(factorialN).multiply(factorialN).multiply(2 * n + 1));
    return factor;
  }
