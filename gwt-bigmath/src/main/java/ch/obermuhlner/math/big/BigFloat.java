...
/**
 * A wrapper around {@link BigDecimal} which simplifies the consistent usage of the {@link
 * MathContext} and provides a simpler API for calculations.
 *
 * <h1>Overview</h1>
 *
 * <p>Every {@link BigFloat} instance has a reference to a {@link Context} that specifies the {@link
 * MathContext} to be used for all calculations and values.
 *
 * <p>The API for calculations is simplified and more consistent with the typical mathematical
 * usage.
 *
 * <ul>
 *   <li>Factory methods for values:
 *       <ul>
 *         <li><code>valueOf(BigFloat)</code>
 *         <li><code>valueOf(BigDecimal)</code>
 *         <li><code>valueOf(int)</code>
 *         <li><code>valueOf(long)</code>
 *         <li><code>valueOf(double)</code>
 ...
 *       <ul>
 *         <li><code>add(BigFloat)</code>
 *         <li><code>add(BigDecimal)</code>
 *         <li><code>add(int)</code>
 *         <li><code>add(long)</code>
 *         <li><code>add(double)</code>
 *         <li>...
 *       </ul>
 ...
 *         <li><code>log(x)</code>
 *         <li><code>sin(x)</code>
 *         <li><code>min(x1, x2, ...)</code>
 *         <li><code>max(x1, x2, ...)</code>
 *         <li>...
 *       </ul>
 ...
 *       <ul>
 *         <li><code>getMantissa()</code>
 *         <li><code>getExponent()</code>
 *         <li><code>getIntegralPart()</code>
 *         <li><code>getFractionalPart()</code>
 *       </ul>
 *   <li>Equals and Hashcode methods:
 *       <ul>
 *         <li><code>equals(Object)</code> that returns whether two <code>BigFloat</code> values are
 *             mathematically the same
 *         <li><code>hashCode()</code> consistent with <code>equals(Object)</code>
 *       </ul>
 *   <li>Comparison methods:
 *       <ul>
 *         <li><code>isEqual(BigFloat)</code>
 *         <li><code>isLessThan(BigFloat)</code>
 *         <li><code>isLessThanOrEqual(BigFloat)</code>
 *         <li><code>isGreaterThan(BigFloat)</code>
 *         <li><code>isGreaterThanOrEqual(BigFloat)</code>
 *       </ul>
 * </ul>
 *
 * <h1>Usage</h1>
 *
 * <p>Before doing any calculations you need to create a <code>Context</code> specifying the
 * precision used for all calculations.
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>The <code>Context</code> can then be used to create the first value of the calculation:
 *
 * <pre>
 * BigFloat value1 = context.valueOf(640320);
 * </pre>
 *
 * <p>The <code>BigFloat</code> instance holds a reference to the <code>Context</code>. This context
 * is then passed from calculation to calculation.
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>The <code>BigFloat</code> result can be converted to other numerical types:
 *
 * <pre>
...
public class BigFloat implements Comparable<BigFloat>, Serializable {
  ...
  public static final BigFloat POSITIVE_INFINITY =
      new SpecialBigFloat(SpecialBigFloat.Type.POSITIVE_INFINITY);
  ...
  public static final BigFloat NEGATIVE_INFINITY =
      new SpecialBigFloat(SpecialBigFloat.Type.NEGATIVE_INFINITY);
  ...
  /**
   * Creates a {@link Context} with the specified precision and {@link RoundingMode#HALF_UP}
   * rounding.
   *
   ...
   *
   * <p>If the two values do not have the same {@link Context}, the result will contain the {@link
   * Context} with the larger precision.
   *
  ...
  public BigFloat add(BigFloat x) {
    if (x.isSpecial()) return x.add(this);
  ...
  public BigFloat subtract(BigFloat x) {
    if (x.isSpecial()) return negate(x).add(this);
    Context c = max(context, x.context);
  ...
  public BigFloat multiply(BigFloat x) {
    if (x.isSpecial()) return x.multiply(this);
    Context c = max(context, x.context);
  ...
  /**
   * Returns the {@link BigFloat} that is the remainder when dividing <code>this</code> by <code>x
   * </code>.
   *
   * <p>If the two values do not have the same {@link Context}, the result will contain the {@link
   * Context} with the larger precision.
  ...
  /**
   * Returns whether <code>this</code> value is mathematically equal to the <code>other</code>
   * value.
   *
   * @param other the other {@link BigFloat} to compare with
   * @return <code>true</code> if both values are mathematically equal (equivalent to <code>
  ...
  /**
   * Returns whether <code>this</code> value is mathematically less than to the <code>other</code>
   * value.
   *
   * @param other the other {@link BigFloat} to compare with
   * @return <code>true</code> <code>this</code> value is mathematically less than to the <code>
   *     other</code> value (equivalent to <code>this.compareTo(other) &lt; 0</code>
   * @see #compareTo(BigFloat)
   */
  ...
  /**
   * Returns whether <code>this</code> value is mathematically greater than to the <code>other
   * </code> value.
   *
   * @param other the other {@link BigFloat} to compare with
   * @return <code>true</code> <code>this</code> value is mathematically greater than to the <code>
   *     other</code> value (equivalent to <code>this.compareTo(other) &gt; 0</code>
   * @see #compareTo(BigFloat)
   */
  ...
  /**
   * Returns whether <code>this</code> value is mathematically less than or equal to the <code>other
   * </code> value.
   *
   * @param other the other {@link BigFloat} to compare with
   * @return <code>true</code> <code>this</code> value is mathematically less than or equal to the
   *     <code>other</code> value (equivalent to <code>this.compareTo(other) &lt;= 0</code>
   * @see #compareTo(BigFloat)
  ...
  /**
   * Returns whether <code>this</code> value is mathematically greater than or equal to the <code>
   * other</code> value.
   *
   * @param other the other {@link BigFloat} to compare with
   * @return <code>true</code> <code>this</code> value is mathematically greater than or equal to
   *     the <code>other</code> value (equivalent to <code>this.compareTo(other) &gt;= 0</code>
   * @see #compareTo(BigFloat)
  ...
  /**
   * Returns whether <code>this</code> specified {@link BigDecimal} value can be represented as
   * <code>double</code>.
   *
  ...
  /**
   * Returns the mantissa of <code>this</code> value written as <em>mantissa *
   * 10<sup>exponent</sup></em>.
   *
   * <p>The mantissa is defined as having exactly 1 digit before the decimal point.
   *
   * @return the mantissa
   * @see #getExponent()
  ...
  /**
   * Returns the exponent of <code>this</code> value written as <em>mantissa *
   * 10<sup>exponent</sup></em>.
   *
   * <p>The mantissa is defined as having exactly 1 digit before the decimal point.
   *
  ...
  private static final class SpecialBigFloat extends BigFloat {
    ...
    public boolean equals(Object obj) {
      if (this == obj) return true;
      return obj instanceof BigFloat
          && ((BigFloat) obj).isSpecial()
          && ((BigFloat) obj).type() == this.type;
    }
    ...
    public BigDecimal toBigDecimal() {
      throw new UnsupportedOperationException(
          type + " has no corresponding BigDecimal representation");
    }
  ...
  public static class Context implements Serializable {
     ...
     *
     * <p>This is equivalent to calling <code>getMathContext().getPrecision()</code>.
     *
     ...
     *
     * <p>This is equivalent to calling <code>getMathContext().getRoundingMode()</code>.
     *
     ...
     * @return the {@link BigFloat} value with this context (rounded to the precision of this
     *     context)
     */
    public BigFloat valueOf(BigFloat value) {
      return value.isSpecial()
          ? value
          : new BigFloat(value.value.round(mathContext), this); // they are final
    }
    ...
    public BigFloat valueOf(int value, boolean unsigned) {
      if (!unsigned) {
        ...
        if (value > -1) return valueOf(value, false);
        return new BigFloat(
  ...
  public static BigFloat negate(BigFloat x) {
    if (x.isSpecial())
      if (x.isInfinity()) return x == POSITIVE_INFINITY ? NEGATIVE_INFINITY : POSITIVE_INFINITY;
      else return NaN;
  ...
  public static BigFloat abs(BigFloat x) {
    if (x.isSpecial()) return x.isInfinity() ? POSITIVE_INFINITY : NaN;
  ...
  private static BigFloat logSpecial(BigFloat val) {
    if (val.isNaN() || val.isNegative()) return NaN;
    if (val == POSITIVE_INFINITY) return POSITIVE_INFINITY;
    if (val.isZero()) return NEGATIVE_INFINITY;
    return null;
  }
  ...
  public static BigFloat log(BigFloat x) {
    ...
    return temp != null
        ? temp
        : x.context.valueOf(BigDecimalMath.log(x.value, x.context.mathContext));
  }
  ...
  public static BigFloat log2(BigFloat x) {
    ...
    return temp != null
        ? temp
        : x.context.valueOf(BigDecimalMath.log2(x.value, x.context.mathContext));
  }
  ...
  public static BigFloat log10(BigFloat x) {
    ...
    return temp != null
        ? temp
        : x.context.valueOf(BigDecimalMath.log10(x.value, x.context.mathContext));
  }
  ...
  public static BigFloat exp(BigFloat x) {
    if (x.isSpecial()) return x != NEGATIVE_INFINITY ? x : x.context.ZERO;
  ...
  public static BigFloat sqrt(BigFloat x) {
    if (x.isNaN() || x.isNegative()) return NaN;
    if (x.isZero() || x.isInfinity()) return x;
  ...
  public static BigFloat cot(BigFloat x) {
    ...
    if (x.isZero()) return POSITIVE_INFINITY;
  ...
  public static BigFloat atan(BigFloat x) {
    return x.isSpecial() || x.isZero()
        ? x
        : x.context.valueOf(BigDecimalMath.atan(x.value, x.context.mathContext));
  }
  ...
  public static BigFloat acot(BigFloat x) {
    return x.isSpecial()
        ? x
        : x.context.valueOf(BigDecimalMath.acot(x.value, x.context.mathContext));
  }
  ...
  public static BigFloat cosh(BigFloat x) {
    ...
    if (x.isInfinity()) return POSITIVE_INFINITY;
    if (x.isZero()) return x.context.ONE;
  ...
  public static BigFloat tanh(BigFloat x) {
    ...
    if (x.isInfinity()) return x == POSITIVE_INFINITY ? x.context.ONE : x.context.NEGATIVE_ONE;
