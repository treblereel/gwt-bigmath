...
@J2clTestInput(BigComplexTest.class)
public class BigComplexTest {
	...
	public void testToString() {
		...
		assertEquals("(1.2 - 3.4 i)", BigComplex.valueOf(1.2, -3.4).toString());
		//in jre it's (1.2 + 0.0 i)
		assertEquals("(1.2 + 0 i)", BigComplex.valueOf(1.2, 0.0).toString());
		//in jre it's (0.0 + 3.4 i)
		assertEquals("(0 + 3.4 i)", BigComplex.valueOf(0.0, 3.4).toString());
	}
