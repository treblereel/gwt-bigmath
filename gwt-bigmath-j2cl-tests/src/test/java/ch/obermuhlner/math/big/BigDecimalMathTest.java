...
@J2clTestInput(BigDecimalMathTest.class)
public class BigDecimalMathTest {
	...
	private static TestLevel TEST_LEVEL = TestLevel.Fast;
    ...
    private void assertToBigDecimalThrows(String string) {
/*		try {
		...
		try {
			BigDecimalMath.toBigDecimal(string, MathContext.UNLIMITED, 1);
			fail("Should throw Exception");
		} catch (Exception e) {
			// expected
		}*/
    ...
    */
	...
	//@Test works but it takes toooo much time
